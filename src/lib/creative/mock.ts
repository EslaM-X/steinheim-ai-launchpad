...
const BEATS: Array<Omit<Shot, "duration_seconds">> = [
  { visual: "Black frame, single water drop sound", prompt: "Pure black frame, faint specular highlight, cinematic grain", camera: "Static", lens: "50mm", lighting: "Single hard key", movement: "None", environment: "Void", transition: "Cut", audio_note: "Water drop", workflow: "image" },
  { visual: "Macro chrome reflection", prompt: "Extreme macro of a polished metal edge, architectural reflection", camera: "Macro", lens: "100mm macro", lighting: "Hard rim light", movement: "Slow push in", environment: "Studio", transition: "Cut", audio_note: "Metal click", workflow: "i2v" },
  { visual: "Marble surface texture", prompt: "Honed marble slab, raking light, fine grain detail", camera: "Top down", lens: "50mm", lighting: "Raking window light", movement: "Slow slide", environment: "Bathroom counter", transition: "Cut", audio_note: "Room tone", workflow: "i2v" },
  { visual: "Water flowing", prompt: "Slow motion water column, clean laminar flow, dark background", camera: "Side", lens: "85mm", lighting: "Backlight", movement: "Static", environment: "Studio", transition: "Dissolve", audio_note: "Water", workflow: "i2v" },
  { visual: "Architectural bathroom reveal", prompt: "Wide luxury bathroom, stone and dark joinery, warm architectural light", camera: "Wide", lens: "24mm", lighting: "Practical + soft key", movement: "Slow dolly in", environment: "Luxury bathroom", transition: "Cut", audio_note: "Ambience", workflow: "i2v" },
  { visual: "Product detail", prompt: "Close detail of the product body and finish, exact factory geometry", camera: "Close", lens: "85mm", lighting: "Soft key + rim", movement: "Slight orbit", environment: "Bathroom", transition: "Cut", audio_note: "Bass riser", workflow: "i2v" },
  { visual: "Hand interaction", prompt: "Hand operating the product, natural motion, correct mounting", camera: "Medium close", lens: "50mm", lighting: "Warm key", movement: "Handheld subtle", environment: "Bathroom", transition: "Cut", audio_note: "Metal click", workflow: "i2v" },
  { visual: "Hero product frame", prompt: "Hero product shot, exact geometry and finish, architectural background", camera: "Hero", lens: "85mm", lighting: "Studio architectural", movement: "Slow push", environment: "Bathroom", transition: "Cut", audio_note: "Impact", workflow: "i2v" },
  { visual: "Full bathroom composition", prompt: "Full room composition with the product in context", camera: "Wide", lens: "28mm", lighting: "Natural + practical", movement: "Static", environment: "Luxury bathroom", transition: "Dissolve", audio_note: "Ambience", workflow: "i2v" },
  { visual: "Brand statement", prompt: "Typographic frame on stone texture", camera: "Static", lens: "50mm", lighting: "Soft", movement: "None", environment: "Void", transition: "Cut", audio_note: "Silence", workflow: "image" },
  { visual: "Logo + CTA", prompt: "STEINHEIM lockup with call to action", camera: "Static", lens: "50mm", lighting: "Flat", movement: "None", environment: "Void", transition: "Fade", audio_note: "Final impact", workflow: "image" },
];
...
export function mockShots(totalSeconds: number, productLine: string): Shot[] {
  const count = totalSeconds <= 10 ? 5 : totalSeconds <= 15 ? 7 : totalSeconds <= 20 ? 9 : BEATS.length;
